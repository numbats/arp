...
* Lecture slides
* **C++** scripts:
  * [`nicetry.cpp`](nicetry.cpp)
  * [`nicelr.cpp`](nicelr.cpp)
  * [`nicelist.cpp`](nicelist.cpp)
  * [`nicerig2.cpp`](nicerig2.cpp)
...
* `NAMESPACE` includes dynamic library definition and imports
```
