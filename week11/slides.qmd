...
* more info at [bsvars.org](https://bsvars.org/)

\vspace{0.3cm}\centerline{\includegraphics[width = 3.5cm]{bsvars.org.png}\includegraphics[width = 3.5cm]{bsvars.png}\includegraphics[width = 3.5cm]{bsvarSIGNs.png}}
...
* specify individual columns as `NumericVector` and put them together in a `NumericMatrix` object
