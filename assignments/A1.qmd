...
* Implement a histogram function using base R graphics. Allow the user to specify a bin edge and either the number of bins or the bin width, with sensible defaults. Allow density, frequency, and relative frequency histograms, and the ability to overlay a normal distribution.
...
* Compute the decimal expansion of any fraction to a specified number of places. Extend to any base. e.g., `decimal_expansion(1, 7, 20)` should return `0.1428571428`.
