...
Your task is to produce a short report analysing some data using a quarto template with a targets workflow and a renv environment. You may use any data you choose provided it includes at least 1000 observations. Possible sources of data include:
