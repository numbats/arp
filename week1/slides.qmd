...
20. Can you simultaneously permute the rows and columns in one step?
21. How would you select a random sample of m rows from a data frame? What if the sample had to be contiguous (i.e., with an initial row, a final row, and every row in between)?
22. How could you put the columns in a data frame in alphabetical order?
...
23. In `hist()`, the default value of `xlim` is `range(breaks)`, the default
...
24. Explain why this function works. Why is it confusing?
...
25. Explain the following results: \fontsize{10}{10}\sf
...
26. Clarify the following list of odd function calls:
...
27. Explain the results of running the following code
