...
\placefig{10}{1}{width=6cm}{../diagrams/vectors/summary-tree-s3-1.png}
...
* Similar to factors but order of levels is meaningful.
...
* `read.csv()` automatically converts character vectors to factors.
* Use argument `stringsAsFactors = FALSE` to suppress this behaviour
...
\placefig{10}{1.5}{width=5cm}{../diagrams/vectors/data-frame-1.png}

\placefig{10}{6}{width=5cm}{../diagrams/vectors/data-frame-2.png}
...
\placefig{10}{2}{width=5cm,height=20cm}{../diagrams/vectors/data-frame-matrix.png}
